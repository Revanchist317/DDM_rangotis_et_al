% This script serves to remove outliers from the raw data and plots the
% output as a figure 
comb_subj_raw = readtable("combined_blocks_humans_raw.csv"); 
...
writetable(comb_subj_raw, 'combined_blocks_humans.csv')